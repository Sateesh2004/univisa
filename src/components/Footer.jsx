      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex flex-col md:flex-row md:justify-between md:items-center gap-8 md:gap-0">
          ...
          <div className="flex justify-center md:justify-start">
            <Link href="/" className="inline-block">
              <Image src="/newLogo.png" alt="Pagedone" width={150} height={150} className="w-auto h-auto" />
            </Link>
          </div>

          {/* Navigation */}
          <nav>
            <ul className="flex flex-col items-center md:flex-row gap-6 md:gap-12">
              <li>
                <Link href="/students" className="text-base md:text-lg text-gray-800 hover:text-gray-900 transition-colors">
                  Students
                </Link>
              </li>
              <li>
                <Link href="/recruitment-partners" className="text-base md:text-lg text-gray-800 hover:text-gray-900 transition-colors">
                  Recruitment Partners
                </Link>
              </li>
              <li>
                <Link href="/institutions" className="text-base md:text-lg text-gray-800 hover:text-gray-900 transition-colors">
                  Institutions
                </Link>
              </li>
              <li>
                <Link href="/contact" className="text-base md:text-lg text-gray-800 hover:text-gray-900 transition-colors">
                  Contact Us
                </Link>
              </li>
            </ul>
        ...
        <div className="flex justify-center items-center space-x-8 mt-8 md:mt-10">
          <Link 
            ...
            aria-label="Twitter"
          >
            <svg className="w-6 h-6 md:w-7 md:h-7" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="none">
          ...
          <Link 
            ...
            aria-label="LinkedIn"
          >
            <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" className="w-6 h-6 md:w-7 md:h-7" viewBox="0 0 16 16">
          ...
          >
            <svg className="w-6 h-6 md:w-7 md:h-7" viewBox="0 0 29 29" fill="none" xmlns="http://www.w3.org/2000/svg">
