      ...
      {isOpen && (
        <div className="md:hidden bg-white border-t">
          <div className="space-y-2 py-4 px-4">
            <a href="/" className="block relative group py-2 text-gray-800">
              <span>Home</span>
            ...
            <a href="/about" className="block relative group py-2 text-gray-800">
              <span>About</span>
              <span className="absolute bottom-0 left-0 w-0 h-0.5 bg-blue-600 group-hover:w-full transition-all duration-300 ease-in-out"></span>
            </a>
            <a href="/services" className="block relative group py-2 text-gray-800">
              <span>Services</span>
              <span className="absolute bottom-0 left-0 w-0 h-0.5 bg-blue-600 group-hover:w-full transition-all duration-300 ease-in-out"></span>
            </a>
            <a href="/contact" className="block relative group py-2 text-gray-800">
              <span>Contact</span>
              <span className="absolute bottom-0 left-0 w-0 h-0.5 bg-blue-600 group-hover:w-full transition-all duration-300 ease-in-out"></span>
            </a>
          </div>
